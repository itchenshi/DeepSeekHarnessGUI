...
> - **Windows icons actually show up now** (white rounded square + brand-blue glyph; uncompressed BMP frames for 16–128 plus a PNG frame for 256, so old quick-launch tools and Windows' "change icon" dialog both work), and **packaging is much faster** — the Node and Electron archives are cached locally, so repeat builds download nothing and even work offline.
>
